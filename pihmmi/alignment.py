...
class GlobalAlignment:
    ...
    def __init__(self, seq1: str, seq2: str, gap: int,  matrix=None):
        self.seq1 = seq1.upper()
        self.seq2 = seq2.upper()
        self.gap = gap
        self.matrix = matrix or substitution_matrices.load("BLOSUM62")


    def align(self):
        """Global alignment using substitution matrix"""
    ...
    def compute_distance_matrix(self):
        ...
        for i in range(num_seqs):
            for j in range(i + 1, num_seqs):
                ...
                aligned_seq1, aligned_seq2 = GlobalAlignment(seq1, seq2,gap=-2).align()
